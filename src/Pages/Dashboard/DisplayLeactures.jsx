...
import {
  ...
  getCourseLectures,
} from "../../../Redux/LectureSlice.js";
const DisplayLeactures = () => {
    ...
    <HomeLayout>
      <div className="flex flex-col gap-10 items-center justify-center min-h-[90vh] py-10 text-wihte mx-[5%]">
        ...
        {lectures && lectures.length > 0 ? (
          ...
          (role === "ADMIN") && (
            <div className="flex flex-col justify-center items-center gap-5 text-yellow-500  text-xl shadow-md">
                <h3>There are no lectures present of this course add some lectures</h3>
            <button
              onClick={() =>
                navigate("/course/addlecture", { state: { ...state } })
              }
...
export default DisplayLeactures;
